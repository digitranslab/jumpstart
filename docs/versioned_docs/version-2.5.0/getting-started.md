...
- **[Try JumpStart on your local machine](/docs/setup/try-jumpstart/)**: the fastest way to try out JumpStart on your computer using Docker.
:::info
...
:::info
JumpStart applications' user interface is constructed using components such as tables, forms, charts, or buttons, etc. Check **[Components Catalog](/docs/widgets/overview)** to learn more.
:::
...
To contribute to JumpStart code, plugins, and documentation, refer to our **[Contributing Guide](/docs/2.5.0/category/contributing-guide)**.
