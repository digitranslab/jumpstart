...
5. Upon clicking **Run**, your browser prompts you to grant permission for the JumpStart app to access your location. Allow this permission to receive location data.
  <div style={{textAlign: 'center'}}>
