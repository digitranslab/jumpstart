...
You will be prompted to select the data source that you wish to add. Let's select PostgreSQL for this tutorial. You will then need to provide the credentials of your PostgreSQL database. The fields that are marked as `encrypted` will be encrypted before saving to JumpStart's database. 

<div style={{textAlign: 'center'}}>

![JumpStart - Tutorial - Adding a data source](/img/tutorial/adding-datasource/datasources.png)
...
:::tip
If you are using JumpStart cloud and if your data source is not publicly accessible, please white-list our IP address ( shown while creating a new data source ).
:::
