...
:::info
You should set up a PostgreSQL database manually to be used by JumpStart. We recommend using an RDS PostgreSQL database. You can find the system requirements [here](/docs/setup/system-requirements#database-software)
:::
...
To use JumpStart Database, you'd have to set up and deploy a PostgREST server, which helps in querying the JumpStart Database. Please [follow the instructions here](/docs/setup/env-vars/#enable-jumpstart-database-required).
