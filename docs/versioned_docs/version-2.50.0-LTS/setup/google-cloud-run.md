...
7. Additional Environmental variable to be added to JumpStart application or JumpStart Server connect to PostgREST server. You can also refer env variable [**here**](./env-vars/#enable-jumpstart-database--optional-)
