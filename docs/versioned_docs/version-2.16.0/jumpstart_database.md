...
<img className="screenshot-full" src="/img/v2-beta/database/newui/tjdb1.png" alt="JumpStart Database" />
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/tjdbdash.png" alt="JumpStart Database editor" />
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/tables1.png" alt="JumpStart Database editor"/>
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/create1.png" alt="JumpStart Database editor"/>
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/create2.png" alt="JumpStart Database editor"/>
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/newtable2.png" alt="JumpStart Database editor"/>
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/search1.png" alt="JumpStart Database editor" />
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/newcolumn1.png" alt="JumpStart Database editor"/>
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/filter1.png" alt="JumpStart Database editor" />
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/sort1.png" alt="JumpStart Database editor" />
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/exporttable.png" alt="JumpStart Database editor" />
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/delete1.png" alt="JumpStart Database editor" />
