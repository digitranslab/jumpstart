...
:::danger
Single-user operation endpoints were updated from plural to singular after v2.61.0. Ensure you're using documentation that corresponds to your JumpStart version.
:::
