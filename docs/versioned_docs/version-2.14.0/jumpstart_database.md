...
<img className="screenshot-full" src="/img/v2-beta/database/newui/db.png" alt="JumpStart Database" />
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/tjdbside.png" alt="JumpStart Database editor" />
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/tables.png" alt="JumpStart Database editor"/>
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/newtable.png" alt="JumpStart Database editor"/>
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/drawer.png" alt="JumpStart Database editor"/>
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/newtable2.png" alt="JumpStart Database editor" width="500"/>
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/search.png" alt="JumpStart Database editor" />
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/newcolumn2.png" alt="JumpStart Database editor"/>
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/filter2.png" alt="JumpStart Database editor" />
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/sort2.png" alt="JumpStart Database editor" />
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/newrow2.png" alt="JumpStart Database editor" />
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/editrow.gif" alt="JumpStart Database editor"  />
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/deleterecord.png" alt="JumpStart Database editor" />
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/delcol.png" alt="JumpStart Database editor" />
...
<img className="screenshot-full" src="/img/v2-beta/database/newui/edittable.png" alt="JumpStart Database editor" />
...
- Go to the **query panel**, and click on the **+Add** button to add a new query, and select **Run JumpStartDb query**
    ...
    <img className="screenshot-full" src="/img/v2-beta/database/newui/q1.png" alt="JumpStart Database editor" />
...
- Enter the **Name** of the table that you want to query, select an **Operation** from the dropdown, **Create** the query, and then **Run** the query to get the response.
    ...
    <img className="screenshot-full" src="/img/v2-beta/database/newui/q2.png" alt="JumpStart Database editor" />
