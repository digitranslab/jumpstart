...
1. Navigate to **JumpStart DB Editor** from the left sidebar on the dashboard
    ...
    <img className="screenshot-full" src="/img/v2-beta/getting_started/quickstart/compressed/jumpstartdbeditor.webp" width="100%" height="100%" alt="Getting started: Quickstart" />
...
1. We can add a new datasource from the **[Global datasources](/docs/data-sources/overview)** page from the dashboard but since we are using **JumpStart Database** we don't need to add any external datasource. Go to the **Query Panel and select JumpStart Database**
    ...
    <img className="screenshot-full" src="/img/v2-beta/getting_started/quickstart/compressed/jumpstartdb.webp" width="100%" height="100%" alt="Getting started: Quickstart" />
...
To contribute to JumpStart code, plugins, and documentation, refer to our **[Contributing Guide](/docs/2.15.0/category/contributing-guide)**.
