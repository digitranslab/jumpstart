...
2. **Attach the Jumpstart app’s PostgreSQL database your Jumpstart database app**
  ...
  You can get the `${HEROKU_PG_DB_NAME` of the Jumpstart application from the Resources tab under Heroku Postgres attachments as shown below. (eg: `${HEROKU_PG_DB_NAME = postgresql-transparent-24158` ). 
