...
:::info
Please note that you need to set up a PostgreSQL database manually to be used by JumpStart
:::
...
5. Click on "Review + create" and wait for the template to be verified and passed, as shown in the screenshot below.
 ...
 <img className="screenshot-full" src="/img/setup/azure-container/step5.png" alt="Deploying JumpStart on Azure container apps" />
