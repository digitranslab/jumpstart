...
2. Update JumpStart deployment with the appropriate env variables [here](https://github.com/digitranslab/jumpstart/blob/chore/main/kubernetes/GKE/deployment.yaml#L62) and apply the changes.
