...
- In the app editor, go to the query panel at the bottom and create a **[RunJS query](/docs/2.9.0/data-sources/run-js/#runjs-query-examples)** by selecting **Run JavaScript Code** as the datasource
