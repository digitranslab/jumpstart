...
JumpStart ships with its built-in database called **[JumpStart DB](/docs/jumpstart-database)** (built on top of PostgreSQL). You can also connect to **external data sources** such as **databases** ( PostgreSQL, MongoDB, MS SQL Server, Snowflake, BigQuery, etc. ), **API/GraphQL endpoints**, **SaaS tools** ( Airtable, Stripe, Google Sheets, etc.) and **cloud object storage services** ( AWS S3, Google Cloud Storage, and Minio ). 
...
<img className="screenshot-full" src="/img/v2-beta/getting_started/howtjworks.png" alt="How JumpStart works flow" />
...
To contribute to JumpStart code, plugins, and documentation, refer to our **[Contributing Guide](/docs/2.9.0/category/contributing-guide)**.
...
<a href="https://github.com/digitranslab/jumpstart/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=digitranslab/jumpstart&max=360&columns=20" />
</a>
