...
<img className="screenshot-full" src="/img/widgets/list-view/exposed2.png" alt="JumpStart - List view widget" />
...
<img className="screenshot-full" src="/img/widgets/list-view/children.png" alt="JumpStart - List view widget" />
