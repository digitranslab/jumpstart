...
export const commonText = {
  ...
  welcomeJumpstartWorkspace: "Welcome to your new JumpStart workspace",
  introductionMessage:
  ...
  signInSubHeader: "New to JumpStart?Create an account",
  SignUpSectionHeader: "Join JumpStart",
  ...
  backArrowText: "Back",
  skipArrowText: "Skip",
  selfHostSetUpCardHeader: "Hello, Welcome to JumpStart!",
  selfHostSetUpCardSubHeader:
    "Let’s set up your workspace to get started with JumpStart",
  setUpJumpStartButton: "Set up JumpStart",
  ...
  onboardingPageSubHeader: "This information will help us improve JumpStart.",
  ...
  continueToSetUp: "Continue to set up your workspace to start using JumpStart.",
  ...
  newToJumpstartText: "New to JumpStart?",
  ...
  resetPasswordPageDescription:
    "Your password has been reset successfully, log into JumpStart to continue your session",
