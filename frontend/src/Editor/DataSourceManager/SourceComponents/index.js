...
import JumpstartDbSchema from '../../QueryManager/QueryEditors/JumpstartDatabase/manifest.json';
import RunpySchema from './Runpy.schema.json';

// eslint-disable-next-line import/no-unresolved
import { allManifests } from '@jumpstart/plugins/client';
...
export const OtherSources = [RunjsSchema.source, RunpySchema.source, JumpstartDbSchema.source];
